...
TEST_USER_PASSWORD = 'T3s!p4s5wORDd12#'
...
def test_request_without_authentication(client):
    ...
    an appropriate authentication header
    """
    response = client.get(
...
def test_create_duplicated_notification_category(client):
    """
    Ensure we cannot create duplicated notification Category
    """
    create_user_response = create_user(client, TEST_USER_NAME, TEST_USER_PASSWORD)
    assert create_user_response.status_code == HttpStatus.created_201.value
    new_notification_category_name = 'New Information'
...
def test_retrieve_notification_categories_list(client):
    ...
    create_user_response = create_user(client, TEST_USER_NAME, TEST_USER_PASSWORD)
    assert create_user_response.status_code == HttpStatus.created_201.value
    new_notification_category_1 = 'Error'
    post_response_1 = create_notification_category(client, new_notification_category_1)
    assert post_response_1.status_code == HttpStatus.created_201.value
    new_notification_category_2 = 'Warning'
    post_response_2 = create_notification_category(client, new_notification_category_2)
    ...
    assert get_response_data[0]['name'] == new_notification_category_1
    assert get_response_data[1]['name'] == new_notification_category_2
...
def test_update_notification_category(client):
    ...
    create_user_response = create_user(client, TEST_USER_NAME, TEST_USER_PASSWORD)
    assert create_user_response.status_code == HttpStatus.created_201.value
    new_notification_category_1 = 'Error 1'
    post_response_1 = create_notification_category(client, new_notification_category_1)
    assert post_response_1.status_code == HttpStatus.created_201.value
    ...
    new_notification_category_2 = 'Error 2'
    data = {'name': new_notification_category_2}
